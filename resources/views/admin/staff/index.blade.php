    ...
    <div class="right-content-wrapper">
        <div class="top_search_add announcements_filter">
            <div class="search_field col_field">
                <input type="text" id="myInput"  class="form-control" placeholder="Search Staff" id="myInput"  oninput="refreshContent()">
            </div>
            <div class="add-new-customer text-right">
                <a href="{{ route('admin.add_staff')}}" class="admin-theme-btn" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="input_group">
                                    <label for="township" class="form-label">Township<em>*</em></label>
                                    <select class="form-control js-select2" multiple id="township" name="township[]" aria-label="Select township">
                            ...
                            <div class="col-md-12">
                                <div class="input_group">
                                    ...
                                    <input type="hidden" name="attachfileupdate" id="attachfileupdate" class="form-control">
